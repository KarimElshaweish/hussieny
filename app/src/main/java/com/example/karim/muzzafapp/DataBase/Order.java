package com.example.karim.muzzafapp.DataBase;

public class Order {
   public String  placeName,location,Date,time,order,placeType,visiteState,keyPersonName,keyPersonEmail,keyPersonPhoneNumber
            ,keyPersonComments,feedback,contactName,contactPhoneNumber,contactTitle,orderValue;
    ...
    public String getVisiteState() {
        return visiteState;
    }

    public void setVisiteState(String visiteState) {
        this.visiteState = visiteState;
    }
